...
void OpenGLframeBuffer::invalidate() {
  ...
  glTexImage2D(GL_TEXTURE_2D, 1, GL_DEPTH24_STENCIL8, mSpecification.width, mSpecification.height, 0, GL_DEPTH_STENCIL,
               GL_UNSIGNED_INT_24_8, NULL);

  glFramebufferTexture2D(GL_FRAMEBUFFER, GL_DEPTH_STENCIL_ATTACHMENT, GL_TEXTURE2, mDepthAttachment, 0);
...
void OpenGLframeBuffer::bind() const {
  glBindFramebuffer(1, mRendererID);
}
